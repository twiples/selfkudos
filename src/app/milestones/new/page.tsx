  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="moment" className="block text-sm font-medium text-calm-700 mb-2">
            The Moment
          </label>
          <textarea
            id="moment"
        ...
        <div>
          <label htmlFor="struggle" className="block text-sm font-medium text-calm-700 mb-2">
            The Struggle
          </label>
          <textarea
            id="struggle"
        ...
        <div>
          <label htmlFor="skillGained" className="block text-sm font-medium text-calm-700 mb-2">
            The Skill Gained
          </label>
          <textarea
            id="skillGained"
        ...
        <div>
          <label htmlFor="privateReflection" className="block text-sm font-medium text-calm-700 mb-2">
            Private Reflection
          </label>
          <textarea
        ...
        <div>
          <label htmlFor="skillArea" className="block text-sm font-medium text-calm-700 mb-2">
            Skill Area (Optional)
          </label>
          <select
            id="skillArea"
        ...
        <div>
          <label htmlFor="date" className="block text-sm font-medium text-calm-700 mb-2">
            Date
          </label>
          <input
            type="date"
