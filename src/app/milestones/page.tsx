  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/milestones/new"
          className="px-4 py-2 bg-coral-600 text-white rounded-lg text-sm font-medium hover:bg-coral-700 transition-colors"
        >
          Record Milestone
        </Link>
      </div>
      ...
      {filteredMilestones.length > 0 ? (
        ...
        <div className="text-center py-12 bg-coral-50 rounded-2xl border border-coral-200">
          ...
          {filter === 'all' && (
            <Link
              href="/milestones/new"
              className="inline-flex px-4 py-2 bg-coral-600 text-white rounded-lg text-sm font-medium hover:bg-coral-700 transition-colors"
            >
