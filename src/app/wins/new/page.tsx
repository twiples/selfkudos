...
export default function NewWinPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      <h1 className="text-2xl font-semibold text-stone-900 mb-2">Capture a Private Win</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label htmlFor="significance" className="block text-sm font-medium text-stone-700 mb-2">
        ...
        <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
          <h3 className="text-sm font-medium text-stone-700 mb-2">Examples of Private Wins</h3>
