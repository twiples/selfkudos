  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="content" className="block text-sm font-medium text-calm-700 mb-2">
        ...
        <div>
          <label htmlFor="significance" className="block text-sm font-medium text-calm-700 mb-2">
        ...
        <div className="bg-calm-50 rounded-xl p-4">
          <h3 className="text-sm font-medium text-calm-700 mb-2">Examples of Private Wins</h3>
