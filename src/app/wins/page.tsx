  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-stone-900">Private Wins</h1>
      ...
      {sortedGroups.length > 0 ? (
        <div className="space-y-8">
          {sortedGroups.map(([key, group]) => (
            <div key={key}>
              <h2 className="text-sm font-medium text-stone-500 mb-3">{group.label}</h2>
        ...
        <div className="text-center py-12 bg-stone-50 rounded-2xl border border-stone-200">
          <h2 className="text-lg font-semibold text-stone-800 mb-2">No wins recorded yet</h2>
          ...
          <Link
            href="/wins/new"
            className="inline-flex px-4 py-2 bg-stone-800 text-white rounded-lg text-sm font-medium hover:bg-stone-900 transition-colors"
          >
