  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/wins/new"
          className="px-4 py-2 bg-gold-600 text-white rounded-lg text-sm font-medium hover:bg-gold-700 transition-colors"
        >
          Capture Win
        </Link>
      </div>
      ...
      {sortedGroups.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gold-50 rounded-2xl border border-gold-200">
          ...
          <Link
            href="/wins/new"
            className="inline-flex px-4 py-2 bg-gold-600 text-white rounded-lg text-sm font-medium hover:bg-gold-700 transition-colors"
          >
